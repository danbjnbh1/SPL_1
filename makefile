...
link: compile
	@echo 'Linking'
	g++ -o bin/simulation bin/main.o bin/Auxiliary.o bin/Settlement.o bin/Facility.o bin/SelectionPolicy.o

compile: src/main.cpp src/Auxiliary.cpp src/Facility.cpp src/Settlement.cpp src/SelectionPolicy.cpp src/Simulation.cpp src/Action.cpp
	@echo "Compiling"
